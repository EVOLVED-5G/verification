...
Create subscription by Authorized NetApp
    ...
    ${resp}=             Run Keyword    netapp_to_nef.sessionqos_subscription    ${CONFIG.credentials.nef_ip}    ${CONFIG.credentials.nef_port}    ${CONFIG.credentials.callback_ip}    ${CONFIG.credentials.nef_callback_port}    ${access_token}
...
Create subscription by unAuthorized NetApp
    ...
    ${resp}=      Run Keyword    netapp_to_nef.sessionqos_subscription    ${CONFIG.credentials.nef_ip}    ${CONFIG.credentials.nef_port}    ${CONFIG.credentials.callback_ip}    ${CONFIG.credentials.nef_callback_port}    ${non-auth}
