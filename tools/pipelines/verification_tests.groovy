                ...
                stage("Run test cases."){
                    steps{
                        sh """
                            ...
                            -c "robot ./tests/capif_invoker_tests/dummy-tests.robot; \
                                robot ./tests/capif_discover_services/discover_services_tests.robot; \
                                robot ./tests/capif_publish_services/publish_services_tests.robot;"
                        """
